...
python utils/main.py --run original --seed $SEED --wandb_entity leilaa-mahmoudi \
    ...
    --model xder --alpha 0.6 --beta 0.9 --m 0.2 --gamma 0.85 --lambd 0.05 --eta 0.01 \
    --epoch_base 60 --sch0 0 \
    --epoch_cl 60 --sch 0 --sch_ms "35 45"\
    --epoch_fl 0 --schf 0 \
    --dataset seq-cifar100 --batch_size 32 --minibatch_size 32 --simclr_batch_size 64 \
    --buffer_size 2000  \
